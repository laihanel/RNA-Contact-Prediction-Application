...
We use the [train/val](CoT_Transfer_Learning/RNA_DATASET/) and [testing](CoT_Transfer_Learning/RNA_TESTSET/) datasets from [coconet](https://github.com/KIT-MBS/coconet).
