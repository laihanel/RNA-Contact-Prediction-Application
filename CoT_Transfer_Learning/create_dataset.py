...
class CoCoNetDataset:
    ...
    def __init__(self, data_dir, linear_dist=None, contact_dist=None):
        ...
        pdb_chains_list_file = os.path.join(self.__data_dir, 'CCNListOfPDBChains2.txt')
        msa_files_list_file = os.path.join(self.__data_dir, 'CCNListOfMSAFiles2.txt')
        pdb_files_list_file = os.path.join(self.__data_dir, 'CCNListOfPDBFiles2.txt')
